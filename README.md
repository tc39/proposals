...
| [JSON.parse source text access][json-parse-source]                             | Richard Gibson                                                          | Richard Gibson                                                          | <sub>[json-parse-with-source][json-parse-with-source-tests]</sub>   | <sub>[January&nbsp;2023][json-parse-source-notes]</sub>    |
...
[json-parse-with-source-tests]: https://github.com/tc39/test262/search?l=JavaScript&q=json-parse-with-source
